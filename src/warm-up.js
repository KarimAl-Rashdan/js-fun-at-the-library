//tions for each of the warm up exercises carefully. This may
...
if (pages < 25) {
  console.log(isShortStory === true);
} else {
  console.log(isShortStory === false);
  }
...
var books = ["A Dream of a Woman", "PolySecure", "The Black Book", "The Power is Within You", "Trannies on My Porch"];
...
var belowTwoHundred = [3,6,2,80,92,43,84,7,24,32,19,12];
